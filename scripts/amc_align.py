...
parser.add_argument('--amc_raw_dir', type=str, default='DCM_data/amc_raw_data/')
parser.add_argument('--amc_raw_camera_json_dir', type=str, default='DCM_data/amc_camera_json/')
parser.add_argument('--amc_motion_transform_json_dir', type=str, default='DCM_data/Simplified_MotionGlobalTransform/')
